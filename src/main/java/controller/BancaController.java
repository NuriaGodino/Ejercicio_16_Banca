...
public class BancaController {
	...
	@GetMapping(value = "MovimientosFecha", produces = MediaType.APPLICATION_JSON_VALUE)
	...
	@PostMapping("Ingreso")
	public String ingreso(@ModelAttribute MovimientoDto movimiento) {
		service.ingreso(movimiento);
		return "";
	}
